...
## [2.36.0](https://github.com/launchdarkly/sdk-test-harness/compare/v2.35.0...v2.36.0) (2026-04-22)
...
* Add capability and test for context comparison ([#173](https://github.com/launchdarkly/sdk-test-harness/issues/173)) ([da5d6d9](https://github.com/launchdarkly/sdk-test-harness/commit/da5d6d9ebc2e0078a06da5428fbf988cfc77588e))
* Add client-side support for anonymous attribute redaction in feature events ([#178](https://github.com/launchdarkly/sdk-test-harness/issues/178)) ([e586b47](https://github.com/launchdarkly/sdk-test-harness/commit/e586b47534a7bf2a865e355efae7c9b37a308f2e))
...
* Add e-tag caching capability and supporting tests ([#174](https://github.com/launchdarkly/sdk-test-harness/issues/174)) ([b8d0ee0](https://github.com/launchdarkly/sdk-test-harness/commit/b8d0ee05eef6bb1df3147fbd4d2ba4fe5f1a1c83))
* Add error condition measurement tests ([#162](https://github.com/launchdarkly/sdk-test-harness/issues/162)) ([abb99ca](https://github.com/launchdarkly/sdk-test-harness/commit/abb99ca09f7298650db2abf63464dec0c25bc9b7))
* Add filtered environment tests ([#122](https://github.com/launchdarkly/sdk-test-harness/issues/122)) ([ebd6721](https://github.com/launchdarkly/sdk-test-harness/commit/ebd67216eb671c087b95a1bc6364428928c85096))
...
* Add initial migration related tests ([#149](https://github.com/launchdarkly/sdk-test-harness/issues/149)) ([0b08aad](https://github.com/launchdarkly/sdk-test-harness/commit/0b08aad541116d5e2b8e9efcc2875d034d312d6a))
* Add multi-kind user target segment matching. ([#145](https://github.com/launchdarkly/sdk-test-harness/issues/145)) ([bc88dc2](https://github.com/launchdarkly/sdk-test-harness/commit/bc88dc2ff8607dc925bd8019be9158ac1908504c))
* Add php support for anonymous attribute redaction in feature events ([#182](https://github.com/launchdarkly/sdk-test-harness/issues/182)) ([31b4d6f](https://github.com/launchdarkly/sdk-test-harness/commit/31b4d6f9987adc38ab5fa88700d0da59bbf361c6))
* Add PHP support for migration related tests ([#169](https://github.com/launchdarkly/sdk-test-harness/issues/169)) ([bdebb42](https://github.com/launchdarkly/sdk-test-harness/commit/bdebb4295408dd7b075bf4f93ffb8e9ceb6f2083))
* Add polling test with large payload size ([#136](https://github.com/launchdarkly/sdk-test-harness/issues/136)) ([e6188b5](https://github.com/launchdarkly/sdk-test-harness/commit/e6188b52f9f28cd8e65954a1cddfdbb5b82464c4))
* Add server-side support for anonymous attribute redaction in feature events ([#176](https://github.com/launchdarkly/sdk-test-harness/issues/176)) ([95bd165](https://github.com/launchdarkly/sdk-test-harness/commit/95bd1654105a8ebe3213c1429ae8a748e389c809))
...
* Add test for negated segment match. ([#146](https://github.com/launchdarkly/sdk-test-harness/issues/146)) ([d4cfd7d](https://github.com/launchdarkly/sdk-test-harness/commit/d4cfd7dfa96a1e891cea4ee8849ebdc3c6c71928))
* Add test verifying excludeFromSummaries is set ([#170](https://github.com/launchdarkly/sdk-test-harness/issues/170)) ([556b1a8](https://github.com/launchdarkly/sdk-test-harness/commit/556b1a89510a92ba01c7b54c39bd99bbaf132928))
* Add test verifying gzip behavior for polling ([#185](https://github.com/launchdarkly/sdk-test-harness/issues/185)) ([172d092](https://github.com/launchdarkly/sdk-test-harness/commit/172d09261f820ba41a2e65101aa2d104d3b7517f))
...
* Add tests verifying payload behavior ([#156](https://github.com/launchdarkly/sdk-test-harness/issues/156)) ([8df0254](https://github.com/launchdarkly/sdk-test-harness/commit/8df025493ff335355773925fc2c9f5f80ed96b36))
...
* Adding the capabilities and make sure the new test works ([#161](https://github.com/launchdarkly/sdk-test-harness/issues/161)) ([b631487](https://github.com/launchdarkly/sdk-test-harness/commit/b6314870b60b63475f93ee3afe646639c11c3833))
* adds contract tests for auto env attributes ([14ef5e9](https://github.com/launchdarkly/sdk-test-harness/commit/14ef5e93c1ad99dc4f49cdee7c97a7677c79bd8c))
* adds contract tests for client independence ([#184](https://github.com/launchdarkly/sdk-test-harness/issues/184)) ([8c45156](https://github.com/launchdarkly/sdk-test-harness/commit/8c45156fe33090d04dca5ed936203abdfe544883))
* adds contract tests for verifying client instances can operate independently ([7012a78](https://github.com/launchdarkly/sdk-test-harness/commit/7012a78a9e830c262358d41fc4dde2e76f51894e))
* Allow configuring the query timeout. ([#180](https://github.com/launchdarkly/sdk-test-harness/issues/180)) ([a231f7e](https://github.com/launchdarkly/sdk-test-harness/commit/a231f7e0faf1aa06943f17feffcbffa46f7f8194))
...
* Allow samplingRatio of 1 to be omitted for measurements. ([#159](https://github.com/launchdarkly/sdk-test-harness/issues/159)) ([6095565](https://github.com/launchdarkly/sdk-test-harness/commit/60955653dd32cee7d209b937929b2422542c3ab2))
* Disable consistency through check ratio ([#157](https://github.com/launchdarkly/sdk-test-harness/issues/157)) ([b79aefe](https://github.com/launchdarkly/sdk-test-harness/commit/b79aefe8567d4ef472d139e648ffe2b2a368eef3))
* Downloader support for windows. ([#147](https://github.com/launchdarkly/sdk-test-harness/issues/147)) ([9f46fcf](https://github.com/launchdarkly/sdk-test-harness/commit/9f46fcf0e0a6a48c81b31ff7cf9d9f68fadf7e3d))
...
* Flag and custom sampling ratios and flag summary tests ([#153](https://github.com/launchdarkly/sdk-test-harness/issues/153)) ([ca33f58](https://github.com/launchdarkly/sdk-test-harness/commit/ca33f58369a69cf484fd38bcd1fc43343ff5c6cf))
...
* MigrationOp should use WRONG_TYPE for non-migration flag ([#164](https://github.com/launchdarkly/sdk-test-harness/issues/164)) ([7c5bd73](https://github.com/launchdarkly/sdk-test-harness/commit/7c5bd73d32cda90078f2a087687f9561b8d2d385))
* Migrations execution permutations and edge conditions. ([#163](https://github.com/launchdarkly/sdk-test-harness/issues/163)) ([88cb445](https://github.com/launchdarkly/sdk-test-harness/commit/88cb445ecebd25784224e60e8a2a7b1d07d185ec))
* refactor auto env attribute tests to be more robust ([#168](https://github.com/launchdarkly/sdk-test-harness/issues/168)) ([8c5d334](https://github.com/launchdarkly/sdk-test-harness/commit/8c5d334f15a33fda304b33bd1bb83c3192d43f49))
* Support inline context payloads for feature events ([#175](https://github.com/launchdarkly/sdk-test-harness/issues/175)) ([934334b](https://github.com/launchdarkly/sdk-test-harness/commit/934334b28056ca2d61ce49fecab55a864f17c484))
* Support PHP v2 and v4 schema payloads ([#181](https://github.com/launchdarkly/sdk-test-harness/issues/181)) ([f610c12](https://github.com/launchdarkly/sdk-test-harness/commit/f610c12abad3b2e7d69456ea0c27d71a4d7e455a))
...
* Verify migration event contains invoked measurement ([#151](https://github.com/launchdarkly/sdk-test-harness/issues/151)) ([e222ed5](https://github.com/launchdarkly/sdk-test-harness/commit/e222ed58a2823858f644527dbbb2190caea4e2e3))
* Verify that event payloads contain the correct content-type header. ([#139](https://github.com/launchdarkly/sdk-test-harness/issues/139)) ([ab3a798](https://github.com/launchdarkly/sdk-test-harness/commit/ab3a7984ee8e5e12f130cc4a27c623325a5900a8))
...
* Add sampling capabality requirement for event disablement. ([#160](https://github.com/launchdarkly/sdk-test-harness/issues/160)) ([ac9b697](https://github.com/launchdarkly/sdk-test-harness/commit/ac9b697fab90e12dd3e76aee069ff84bb29207e2))
...
* Close the gzip stream ensuring it writes the gzip footer. ([#186](https://github.com/launchdarkly/sdk-test-harness/issues/186)) ([b8090a8](https://github.com/launchdarkly/sdk-test-harness/commit/b8090a8cd4daf97061b76b406f41262df9de61f8))
...
* fixing lint issues ([f6ed4bd](https://github.com/launchdarkly/sdk-test-harness/commit/f6ed4bdf76a5ee639e62de841aac41c060fea7a9))
* grammar mistake suggestion ([33f54aa](https://github.com/launchdarkly/sdk-test-harness/commit/33f54aa386b8eec606dcd81389c66da9d03cf503))
* Guard legacy user conversion with capability ([#165](https://github.com/launchdarkly/sdk-test-harness/issues/165)) ([e986ec5](https://github.com/launchdarkly/sdk-test-harness/commit/e986ec540cd66da5d74133394dac0277ea3b5943))
* js client sdk header tests can match auth headers ([21bda67](https://github.com/launchdarkly/sdk-test-harness/commit/21bda679f518e1adfde3ffcf70084a5820cdf58b))
...
* Relaxing content-type for server events. ([#155](https://github.com/launchdarkly/sdk-test-harness/issues/155)) ([1c24472](https://github.com/launchdarkly/sdk-test-harness/commit/1c24472ea683d690a7e7f6b6dc4054d04e9d9369))
* relaxing context type test, now contains application/json ([3ca1ef8](https://github.com/launchdarkly/sdk-test-harness/commit/3ca1ef8c2f0cc1ae19e290c50157e069cc90afcc))
* relaxing context type test, now contains application/json ([#150](https://github.com/launchdarkly/sdk-test-harness/issues/150)) ([870cefa](https://github.com/launchdarkly/sdk-test-harness/commit/870cefa41c7875ae8bf6c11b14c31688c26a2b7a))
...
* Remove support for abandoned top level data kinds ([#166](https://github.com/launchdarkly/sdk-test-harness/issues/166)) ([179f149](https://github.com/launchdarkly/sdk-test-harness/commit/179f1497a3ad8f5994dba214f5e0ebbb7cb8f70f))
...
* URLEncode the context payload on Roku's proxied `meval` request ([#177](https://github.com/launchdarkly/sdk-test-harness/issues/177)) ([627c095](https://github.com/launchdarkly/sdk-test-harness/commit/627c095ec531d079795f46fce55532ec6b991ec4))
* Use correct payload type for server/client in common tests. ([d5dc492](https://github.com/launchdarkly/sdk-test-harness/commit/d5dc492a5cc4c99da129a5a375ee2ba5027c008c))
* Use correct payload type for server/client in common tests. ([#179](https://github.com/launchdarkly/sdk-test-harness/issues/179)) ([9595a36](https://github.com/launchdarkly/sdk-test-harness/commit/9595a36284be1b96b556654919a3c471cf7a237f))
