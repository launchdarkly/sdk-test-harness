...
// PS 1.1.3: validates flag data written to persistent store matches expectations
// PS 1.1.6: validates flag data written to persistent store matches expectations
